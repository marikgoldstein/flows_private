...
class ExperimentConfig:
    def __init__(self, dataset, use_wandb, results_dir, debug):
        ...
        lr_sched = hp.lr_sched  
        delta = hp.delta
        s_denom = main_args.s_denom
        loss_type = hp.loss_type
        backprop_ts = hp.backprop_ts
        backprop_with_weight = hp.backprop_with_weight
        ...
        self.grad_accum = 2
        self.delta = delta                                                                       
        self.s_denom = s_denom
        self.schedule = schedule
        self.loss_type = loss_type
        self.backprop_ts = backprop_ts
        '''
        ...
        if self.debug:
            ...
            self.update_ema_after = 1
            self.update_ema_every = 100
            self.fid_every = 10000000
