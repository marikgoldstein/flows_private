...
class BigUNet(nn.Module):
    def __init__(
        ...
        self.mat_dims = (input_channels, input_height, input_height)
        ...
        if self.use_fourier:
            ...
            # see below
            self.n_fourier = 3
            in_ch = in_ch + in_ch * self.n_fourier * 2
    ...
    def forward(self, x, temp):
        ...
        if self.use_fourier:
            ...
            # NOTE C IS SEEMINGLY NOT USED BELOW,
            # SO IT IS OKAY THAT X'S CHANNELS CHANGED.
            # ALSO B/C WE DID PROPER INIT ABOVE
