...
def get_act(config):
    if config.model_nonlinearity.lower() == 'elu':
        return nn.ELU()
    elif config.model_nonlinearity.lower() == 'relu':
        return nn.ReLU()
    elif config.model_nonlinearity.lower() == 'lrelu':
        return nn.LeakyReLU(negative_slope=0.2)
    elif config.model_nonlinearity.lower() == 'swish':
        def swish(x):
