...
class TimeSampler(nn.Module):
    ...
    def __init__(self, mint, time_change, optimize, device):
        ...
        self.U = Uniform(low=self.o * mint, high=self.o * 1.0)
        self.t_width = 1.0 - mint
        self.t_weight = 1.0
    ...
    def sample(self, bsz):
        ...
        if self.time_change:
            t, w1, w2 = self.sample_changed(bsz)
        else:
            t, w1, w2 = self.sample_U(bsz)
