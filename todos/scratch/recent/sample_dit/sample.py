...
if __name__ == '__main__':
    ...
    # load models
    model = DiT(depth=28, hidden_size=1152, patch_size=2, num_heads=16, input_size = args.latent_size, num_classes = args.num_classes)
    ...
    if cifar:
        ...
        both = torch.cat([x, xhat], dim=0)
        save_image(both, 'both.png', nrow=4, normalize=True, value_range=(-1,1))
        print("done")
        assert False
