...
def setup_data(config, ddp = False, rank = None, **kwargs):
    ...
    if config.use_vae:                                                                                                                            
        ...
        config.C_dgm = 4
        config.H_dgm = config.H // 8
        config.W_dgm = config.W // 8
    else:
        config.C_dgm = config.C
        config.H_dgm = config.H
        config.W_dgm = config.W
